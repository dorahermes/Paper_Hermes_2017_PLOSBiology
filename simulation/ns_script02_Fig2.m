...
%note that these are similar only if data are 1 sec long or add the time period to total_cp
...
print('-depsc','-r300',['./figures/Fig2'])
print('-dpng','-r300',['./figures/Fig2'])
