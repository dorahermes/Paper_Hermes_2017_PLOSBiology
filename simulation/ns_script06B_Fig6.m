...
load(fullfile(boldlfp_RootPath, 'data', sprintf('NS_simnr%d_lookup_table', sim_nr)),'lookup');

% load the data
load(fullfile(boldlfp_RootPath, 'data','boldecog_structure_final.mat'));
    
% make 8 models, with either the level or coherence drivingg the power 
%   column 1: 1:gamma level or 2: gamma coherence
%   column 2: 3: alpha level or 2: alpha coherence
%   column 3: 5: broadband level or 6: broadband coherence
lookup_combs=[...
    2 3 5
    2 4 5
    1 3 5
...
% electrode 18 is used in the PLOS BIOLOGY paper as an example for V2
...
% plot broadband poisson in versus LFP broadband out
...
print('-depsc','-r300',fullfile(boldlfp_RootPath,'figures', 'Fig6'))
print('-dpng','-r300',fullfile(boldlfp_RootPath,'figures', 'Fig6'))
